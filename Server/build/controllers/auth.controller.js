...
exports.register = (0, async_handler_utils_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield (0, bcrypt_1.hash)(password);
    // creating new user
...
exports.login = (0, async_handler_utils_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // if !user => error
        if (!user) {
            throw new error_handler_middleware_1.default("Email or password does not match", 404);
        }
        // compare password
        const isPasswordMatched = yield (0, bcrypt_1.compare)(password, user.password);
        // !match -> error
        ...
        res
            ...
            httpOnly: true,
            maxAge: parseInt((_a = process.env.COOKIE_EXPIRES_IN) !== null && _a !== void 0 ? _a : "7") *
                24 *
                60 *
                60 *
                1000,
